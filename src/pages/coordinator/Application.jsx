...
function Application(props) {
    ...
    return (
        <div className={'flex'}>
            <div className={'basis-1/6 border-r-[1px] border-black h-screen flex flex-col p-8'}>
                            ...
                            <TableBody>
                                {applications?.map((application) => (
                                    <TableRow key={application.id}>
                                        ...
                                        <TableCell>
                                            <Button className="mb-2">CV</Button>
                                            <Button>Academic Record</Button>
                                        </TableCell>
                                        <TableCell>
                                            <Button className="mb-2">Accept</Button>
